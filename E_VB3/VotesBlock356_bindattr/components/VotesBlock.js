  ...
  render() {
    ...
    const answersCode=this.props.answers.map( v =>
      React.createElement(VotesAnswer, {key:v.code,
        ...
        cbSelected:this.answerSelected.bind(this),
        cbFreeAnswerTextChanged:this.freeAnswerTextChanged.bind(this),
    ...
    return React.DOM.div( {className:'VotesBlock'}, 
      ...
      ((this.state.workMode==1)&&this.state.selectedAnswerCode)
        ?React.DOM.input( {type:'button',value:'проголосовать',onClick:this.vote.bind(this)} )
        :null
    );
